...
public class SuspendCommand extends SubCommand<MainCommand> {

    public SuspendCommand(@NotNull MainCommand parent, String identifier, String... aliases) {
    ...
    public Void execute(JavaPlugin plugin, CommandSender sender, String[] args) throws Exception {
        ...
        Main.getContestManager().suspendContest();
